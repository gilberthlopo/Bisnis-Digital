...
export function PaymentPage({ 
  ...
  const totalOrders = 0; // This would come from props in real app
  ...
  const calculatePrice = () => {
    ...
    // Rumus dasar: basePrice × halaman × rangkap × (color multiplier)
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-gray-900/50 backdrop-blur-md rounded-2xl p-8 border border-gray-800 shadow-xl">
            ...
            <div className="space-y-4">
              ...
              {serviceDetail.binding && (
                <div className="flex justify-between pb-4 border-b border-gray-800">
                  <span className="text-gray-400">📚 Jenis Penjilidan</span>
                  <span className="text-white">
                    {serviceDetail.binding === 'spiral' ? 'Spiral' : 'Hard Cover'}
                  </span>
                </div>
              )}
